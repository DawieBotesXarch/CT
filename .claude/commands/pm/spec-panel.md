...
# /pm:spec-panel - Expert Specification Review Panel
...
## Usage
```
/pm:spec-panel [specification_content|@file] [--mode discussion|critique|socratic] [--experts "name1,name2"] [--focus requirements|architecture|testing|compliance] [--iterations N] [--format standard|structured|detailed]
```
...
## Agent Coordination
- **md-documenter**: Professional specification writing and documentation quality
- **architect**: Architectural analysis and system design validation
- **test-engineer**: Quality assessment and testing strategy validation
- **code-reviewer**: Specification quality and technical accuracy review
- **security-specialist**: Security specification and compliance validation
...
- **Task**: Expert panel coordination and iterative analysis delegation
- **WebSearch**: Specification patterns and industry best practices
- **Grep**: Cross-reference validation and consistency checking
- **Write**: Improved specification generation and report creation
- **Edit**: Specification enhancement and refinement
...
Concise format using structured tables and bullet points for efficient communication.
...
```
/pm:spec-panel @auth_api.spec.yml --mode critique --focus requirements,architecture
...
```
/pm:spec-panel "user story content" --mode discussion --experts "wiegers,adzic,cockburn"
...
```
/pm:spec-panel @microservice.spec.yml --mode socratic --focus architecture
...
```
/pm:spec-panel @complex_system.spec.yml --iterations 3 --format detailed
...
### Compliance Review
```
/pm:spec-panel @security_requirements.yml --focus compliance --experts "wiegers,nygard"
...
# (use standard tools or architect agent for code-to-spec)

# Review and improve with expert panel
/pm:spec-panel @generated_auth_spec.yml --mode critique --focus requirements,testing

# Iterative refinement based on feedback
/pm:spec-panel @improved_auth_spec.yml --mode discussion --iterations 2
```

### Learning and Development Workflow
```bash
# Start with socratic mode for learning
/pm:spec-panel @my_first_spec.yml --mode socratic --iterations 2

# Apply learnings with discussion mode
/pm:spec-panel @revised_spec.yml --mode discussion --focus requirements

# Final quality validation with critique mode
/pm:spec-panel @final_spec.yml --mode critique --format detailed
```
