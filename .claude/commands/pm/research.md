...
# /pm:research - Deep Research Command

> This command activates comprehensive research capabilities with adaptive planning, multi-hop reasoning, and evidence-based synthesis.
...
## Usage
```
/pm:research "[query]" [--depth quick|standard|deep|exhaustive] [--strategy planning|intent|unified]
```
...
## Tool Coordination
- **WebSearch**: Primary search engine for current information
- **WebFetch**: Content extraction from specific URLs
- **TodoWrite**: Research task tracking and progress monitoring
- **Write**: Research report generation and documentation

## Output Standards
- Provide comprehensive research summary
...
## Examples
```
/pm:research "latest developments in quantum computing 2024"
/pm:research "competitive analysis of AI coding assistants" --depth deep
/pm:research "best practices for distributed systems" --strategy unified
```
