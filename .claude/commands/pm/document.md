...
# /pm:document - Focused Documentation Generation
...
## Usage
```
/pm:document [target] [--type inline|external|api|guide] [--style brief|detailed]
```
...
```
/pm:document src/auth/login.js --type inline
...
```
/pm:document src/api --type api --style detailed
...
### User Guide Creation
```
/pm:document payment-module --type guide --style brief
...
```
/pm:document components/ --type external
