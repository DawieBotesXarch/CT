...
# /pm:spawn - Meta-System Task Orchestration
...
## Usage
```
/pm:spawn [complex-task] [--strategy sequential|parallel|adaptive] [--depth normal|deep]
```
...
- **Native Orchestration**: Uses native Claude Code tools and agents
- **Progressive Integration**: Systematic execution with quality gates
- **Agent Coordination**: Delegates to specialized agents as needed

## Tool Coordination
- **TodoWrite**: Hierarchical task breakdown and progress tracking across Epic → Story → Task levels
- **Read/Grep/Glob**: System analysis and dependency mapping for complex operations
- **Edit/Write**: Coordinated file operations with parallel and sequential execution
- **Bash**: System-level operations coordination with intelligent resource management
- **Task**: Delegation to specialized agents for domain-specific operations
...
```
/pm:spawn "implement user authentication system"
...
```
/pm:spawn "migrate legacy monolith to microservices" --strategy adaptive --depth deep
...
```
/pm:spawn "establish CI/CD pipeline with security scanning"
