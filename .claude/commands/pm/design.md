...
# /pm:design - System and Component Design
...
## Usage
```
/pm:design [target] [--type architecture|api|component|database] [--format diagram|spec|code]
```
...
```
/pm:design user-management-system --type architecture --format diagram
...
```
/pm:design payment-api --type api --format spec
...
```
/pm:design notification-service --type component --format code
...
```
/pm:design e-commerce-db --type database --format diagram
...
**Will Not:**
- Generate actual implementation code (use /pm:implement for implementation)
