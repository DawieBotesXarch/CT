...
# /pm:analyze - Code Analysis and Quality Assessment
...
## Usage
```
/pm:analyze [target] [--focus quality|security|performance|architecture] [--depth quick|deep] [--format text|json|report]
```
...
```
/pm:analyze src/auth --focus security --depth deep
...
```
/pm:analyze --focus performance --format report
...
### Quick Quality Check
```
/pm:analyze src/components --focus quality --depth quick
