...
/pm [action] [target]  # Shorthand alias
```
...
- **TodoWrite**: Hierarchical task management and progress tracking
- **Task Agent**: Delegation to specialized agents for specific domains
- **WebSearch**: Research project management best practices and methodologies
- **Read/Write/Edit**: Documentation creation and maintenance
...
- **Task Agent**: Complex workstream delegation and multi-agent coordination
  ...
  - code-reviewer: Quality assurance and standards enforcement
...
## Agent Collaboration
When coordinating complex initiatives, leverage specialized Claude Code agents:
- **architect**: Technical strategy, architecture decisions, trade-off analysis
- **code-reviewer**: Quality gate enforcement and technical debt management
- **test-engineer**: Test strategy, coverage analysis, quality assurance
- **security-specialist**: Security requirements and risk assessment
- **performance-engineer**: Performance analysis and optimization planning
